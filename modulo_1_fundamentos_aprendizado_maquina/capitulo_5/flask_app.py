...
app = Flask(__name__,template_folder="/home/notebook/igti/engenharia_machine_leaning/capitulo_5/")
...
def previsao_iris(lista_valores_formulario):
    ...
    modelo_salvo = joblib.load('/home/notebook/igti/engenharia_machine_leaning/capitulo_5//mysite/modelo_knn.joblib')             #realiza a carga do modelo salvo
